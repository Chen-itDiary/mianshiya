...
import com.xiaochen.mianshiya.model.dto.questionbankquestion.*;
...
public class QuestionBankQuestionController {
    ...
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> batchAddQuestionsToBank(@RequestBody QuestionBankQuestionBatchAddRequest questionBankQuestionBatchAddRequest, HttpServletRequest httpServletRequest) {
    ...
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Integer> batchRemoveQuestionsFromBank(@RequestBody QuestionBankQuestionBatchRemoveRequest questionBankQuestionBatchAddRequest, HttpServletRequest httpServletRequest) {
        ThrowUtils.throwIf(questionBankQuestionBatchAddRequest == null, ErrorCode.PARAMS_ERROR);
        Long questionBankId = questionBankQuestionBatchAddRequest.getQuestionBankId();
        List<Long> questionIdList = questionBankQuestionBatchAddRequest.getQuestionIdList();
        Integer countDelete = questionBankQuestionService.batchRemoveQuestionsFromBank(questionIdList, questionBankId);
        return ResultUtils.success(countDelete);
    }
}
